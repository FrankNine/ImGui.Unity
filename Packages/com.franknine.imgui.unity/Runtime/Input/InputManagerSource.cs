...
namespace ImGui.Unity.Input
{
    ...
    internal sealed class InputManagerSource : InputSourceBase 
    {
        ...
        private static void UpdateMouse(ImGuiIOPtr io)
        {
            ...
            io.AddMouseButtonEvent(0, UnityEngine.Input.GetMouseButton(0));
            io.AddMouseButtonEvent(1, UnityEngine.Input.GetMouseButton(1));
            io.AddMouseButtonEvent(2, UnityEngine.Input.GetMouseButton(2));
