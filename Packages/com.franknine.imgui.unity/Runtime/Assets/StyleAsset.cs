...
namespace ImGui.Unity.Assets
{
    ...
    public sealed class StyleAsset : ScriptableObject
    {
        ...
        [Tooltip("Padding within a window.")] public Vector2 WindowPadding;
        ...
        [Tooltip("")] public float LogSliderDeadzone;
        ...
        [HideInInspector] public Color[] Colors = new Color[(int)ImGuiCol.COUNT];
        ...
        public unsafe void ApplyTo(ImGuiStylePtr s)
        {
            ...
            {
                s.Colors[colorIndex] = Colors[colorIndex].ToVector4();
            }
        }
        ...
        {
            System.IntPtr context = ImGuiNET.ImGui.CreateContext();
            ImGuiNET.ImGui.SetCurrentContext(context);
            SetFrom(ImGuiNET.ImGui.GetStyle());
